...
- 1 baris = 1 event pemutaran lagu, bukan 1 lagu unik
...
1. Lagu dianggap di-skip jika `skipped = TRUE`.
2. Lagu dianggap didengarkan sampai selesai jika `skipped = FALSE`, meskipun nilai `ms_played` tidak selalu sama dengan durasi asli lagu.
3. Lagu dengan `ms_played < 30.000` ms diasumsikan sebagai **quick skip** (kurang dari 30 detik).

### Asumsi Engagement

1. Total `ms_played` digunakan sebagai proxy tingkat engagement pengguna.
2. Lagu dengan frekuensi play tinggi dan tingkat skip rendah dianggap memiliki **high user preference**.
3. Mode shuffle diasumsikan dapat memengaruhi tingkat skip dan engagement lagu.
